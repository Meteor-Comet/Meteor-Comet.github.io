...
- [7. 数据绑定（Data Binding）](#5-数据绑定data-binding)
- [8. MVVM设计模式](#6-mvvm设计模式)
- [9. 样式与模板](#7-样式与模板)
- [10. 动画与图形](#8-动画与图形)
- [11. 路由事件与命令系统](#9-路由事件与命令系统)
- [12. WPF性能优化与最佳实践](#10-wpf性能优化与最佳实践)
- [13. MVVM模式进阶与常用框架](#11-mvvm模式进阶与常用框架)
- [14. CommunityToolkit.Mvvm 框架详解](#12-communitytoolkitmvvm-框架详解)

- [15. 轻量级国产 ORM 神器：SqlSugar 详细使用指南](#13-轻量级国产-orm-神器sqlsugar-详细使用指南)
- [16. 全球性能第一的微型 ORM：Dapper 详细使用指南](#14-全球性能第一的微型-ormdapper-详细使用指南)
...
### 14.5 终极杀器：源生器（Source Generators）深度剖析
...
### 14.7 终极进阶：依赖注入（DI）与多窗口自动注册的最佳实践
...
### 15.1 引入 SqlSugar 与基础对象映射 (DbFirst/CodeFirst)
...
### 15.2 进阶操作：结合依赖注入 (DI) 在 WPF 中的应用
...
### 16.2 终极进阶用法：让你彻底告别 EF Core 的底气
