...
- [Django5介绍及安装](#django5介绍及安装)
  - [Django5简介](#django5简介)
  - [Django5安装](#django5安装)
- [Django5项目创建与项目配置](#django5项目创建与项目配置)
  - [Django5创建项目(用命令方式)](#django5创建项目用命令方式)
  - [Django5创建项目(用PyCharm工具)](#django5创建项目用pycharm工具)
- [Django5应用创建与应用配置](#django5应用创建与应用配置)
  - [Django5操作命令](#django5操作命令)
  - [Django5应用创建](#django5应用创建)
  - [Django5应用配置](#django5应用配置)
  - [Django5 Hello World编写](#django5-hello-world编写)
  - [Django5项目配置settings.py文件](#django5项目配置settingspy文件)
- [Django5路由定义与使用](#django5路由定义与使用)
  - [Django5路由定义](#django5路由定义)
  - [Django5路由变量](#django5路由变量)
  - [Django5正则路由](#django5正则路由)
  - [Django5路由重定向](#django5路由重定向)
  - [Django5命名空间namespace](#django5命名空间namespace)
  - [Django5路由命名与反向解析reverse与resolve](#django5路由命名与反向解析reverse与resolve)
- [Django5视图定义与使用](#django5视图定义与使用)
  - [Django5设置视图响应状态](#django5设置视图响应状态)
  - [Django5设置重定向响应](#django5设置重定向响应)
  - [Django5二进制文件下载响应](#django5二进制文件下载响应)
  - [Http请求&HttpRequest请求类](#http请求httprequest请求类)
  - [会话管理（Cookies&Session）](#会话管理cookiessession)
  - [Django5文件上传实现](#django5文件上传实现)
  - [Django5列表视图ListView](#django5列表视图listview)
  - [Django5详细视图DetailView](#django5详细视图detailview)
  - [Django5新增视图CreateView](#django5新增视图createview)
  - [Django5修改视图UpdateView](#django5修改视图updateview)
  - [Django5删除视图DeleteView](#django5删除视图deleteview)
- [Django5模板引擎](#django5模板引擎)
  - [Django5内置模板引擎](#django5内置模板引擎)
  - [Jinja3模版引擎](#jinja3模版引擎)
- [Django5模型定义与使用](#django5模型定义与使用)
  - [Django5模型定义](#django5模型定义)
  - [Django5数据迁移](#django5数据迁移)
  - [Django5模型查询(上)](#django5模型查询上)
  - [Django5模型查询(下)](#django5模型查询下)
  - [Django5模型分页查询](#django5模型分页查询)
  - [Django5高级查询匹配符](#django5高级查询匹配符)
  - [Django5模型多表查询](#django5模型多表查询)
  - [Django5模型数据新增](#django5模型数据新增)
  - [Django5模型数据修改](#django5模型数据修改)
  - [Django5模型数据删除](#django5模型数据删除)
  - [Django5 ORM执行SQL语句](#django5-orm执行sql语句)
  - [Django5 ORM数据库事务](#django5-orm数据库事务)
- [Django5表单定义与使用](#django5表单定义与使用)
  - [Django5 Form表单定义与使用](#django5-form表单定义与使用)
  - [Django5 ModelForm表单定义与使用](#django5-modelform表单定义与使用)
- [Django5内置Admin系统](#django5内置admin系统)
  - [Django5内置Admin系统初体验](#django5内置admin系统初体验)
  - [Django5注册模型到Admin系统](#django5注册模型到admin系统)
  - [Django5内置Admin系统自定义设置](#django5内置admin系统自定义设置)
  - [Django5内置Admin系统二次开发](#django5内置admin系统二次开发)
- [Django5内置Auth认证系统](#django5内置auth认证系统)
  - [用户注册实现](#用户注册实现)
  - [用户登录实现](#用户登录实现)
  - [用户修改密码实现](#用户修改密码实现)
  - [用户注销实现](#用户注销实现)
...
![image-20240131210528300](/images/in-post/post_django/image-20240131210528300.png)
...
![image-20240131220327128](/images/in-post/post_django/image-20240131220327128.png)

当然同时Lib下的site-packages下，也会有一个django目录，这个是后面我们开发项目会用到的django开发包。

![image-20240131220452238](/images/in-post/post_django/image-20240131220452238.png)
...
![image-20240202122717635](/images/in-post/post_django/image-20240202122717635.png)
...
![image-20240202130345896](/images/in-post/post_django/image-20240202130345896.png)
...
![image-20240202134335721](/images/in-post/post_django/image-20240202134335721.png)

执行后，我们去看下 项目目录：

![image-20240202134401394](/images/in-post/post_django/image-20240202134401394.png)

![image-20240202134408937](/images/in-post/post_django/image-20240202134408937.png)
...
![image-20240202205117982](/images/in-post/post_django/image-20240202205117982.png)

相对于用命令方式，PyCharm创建的项目，多了templates目录（用来放html模版文件）,以及settings.py，多了 `BASE_DIR / 'templates'` 

![image-20240202205750355](/images/in-post/post_django/image-20240202205750355.png)
...
![image-20240203062507128](/images/in-post/post_django/image-20240203062507128.png)
...
![image-20240203064746201](/images/in-post/post_django/image-20240203064746201.png)

直接输入命令，比如 `help`，结果就出来，是不是很方便，以后我们就用这种简便方式，来提高工作效率。

![image-20240203064907048](/images/in-post/post_django/image-20240203064907048.png)
...
![image-20240203065945159](/images/in-post/post_django/image-20240203065945159.png)

复杂的电商项目，后台甚至可以拆分用户应用，商品应用，订单应用，支付应用，积分应用，优惠券应用等。

![image-20240203070100404](/images/in-post/post_django/image-20240203070100404.png)

前面我们学过Django5的操作命令，有一个命令是 `startapp`，就是用来创建项目应用APP的。

我们执行 `startapp app01` 创建名字为app01的应用，执行完毕后，多出一个app01目录(目录里的生成文件，我们下一讲解释)

![image-20240203070451378](/images/in-post/post_django/image-20240203070451378.png)

我们还可以继续执行 `startapp app02`,`startapp app03`

![image-20240203070628402](/images/in-post/post_django/image-20240203070628402.png)
...
![image-20240203073932302](/images/in-post/post_django/image-20240203073932302.png)
...
![image-20240203074654173](/images/in-post/post_django/image-20240203074654173.png)

**第二步：注册应用到项目的settings.py**

![image-20240203074900684](/images/in-post/post_django/image-20240203074900684.png)

把helloWorld应用的apps.py里的HelloworldConfig类注册到settings.py里去

![image-20240203075050181](/images/in-post/post_django/image-20240203075050181.png)
...
![image-20240203075648286](/images/in-post/post_django/image-20240203075648286.png)
...
![image-20240203081154387](/images/in-post/post_django/image-20240203081154387.png)
...
![image-20240203081216218](/images/in-post/post_django/image-20240203081216218.png)
...
![image-20240203081416777](/images/in-post/post_django/image-20240203081416777.png)
...
![image-20240203081619080](/images/in-post/post_django/image-20240203081619080.png)
...
![image-20240204152115633](/images/in-post/post_django/image-20240204152115633.png)
...
![image-20240204154907810](/images/in-post/post_django/image-20240204154907810.png)

同时在app目录下再新建一个images目录，放一个qq.jpg头像图片

![image-20240204155057595](/images/in-post/post_django/image-20240204155057595.png)

最后再项目目录下新建一个static，放一个pig.jpg，也试试看是否可以访问；

![image-20240204155505474](/images/in-post/post_django/image-20240204155505474.png)
...
![image-20240204155620143](/images/in-post/post_django/image-20240204155620143.png)
...
![image-20240204163444518](/images/in-post/post_django/image-20240204163444518.png)
...
![image-20240204155805759](/images/in-post/post_django/image-20240204155805759.png)
...
![image-20240204163323694](/images/in-post/post_django/image-20240204163323694.png)

```
http://127.0.0.1:8000/static/qq.jpg
```

![image-20240204163405106](/images/in-post/post_django/image-20240204163405106.png)
...
![image-20240204172234364](/images/in-post/post_django/image-20240204172234364.png)
...
![image-20240204173014299](/images/in-post/post_django/image-20240204173014299.png)
...
![image-20240205121557430](/images/in-post/post_django/image-20240205121557430.png)

views.py里面把index.html改成index2.html

![image-20240205121919651](/images/in-post/post_django/image-20240205121919651.png)

最后就是在DIRS里面加上应用的模版路径即可。

![image-20240205121940320](/images/in-post/post_django/image-20240205121940320.png)
...
![image-20240205122020903](/images/in-post/post_django/image-20240205122020903.png)

但是我们这里有个疑问，如果说应用里的模版和项目里的模版名字一样，起冲突了。这时候，会选择哪个呢，或者说哪个优先级高？

我们测试下吧。把应用里的index2.html改成index.html，以及views.py里面也改下。

![image-20240205122253035](/images/in-post/post_django/image-20240205122253035.png)

然后我们重新运行测试：运行结果显示的是项目里的模版。

![image-20240205122520607](/images/in-post/post_django/image-20240205122520607.png)

锋哥经过查看Django底层源码，其实优先级顺序是根据模版配置的目录顺序来定的，我们前面项目模版在前面，所以就显示项目模版。

如果我们把应用模版配置路径放前面

![image-20240205122706802](/images/in-post/post_django/image-20240205122706802.png)

运行测试下：

![image-20240205122719231](/images/in-post/post_django/image-20240205122719231.png)
...
![image-20240212192654562](/images/in-post/post_django/image-20240212192654562.png)

刷新数据库表：

![image-20240212192803613](/images/in-post/post_django/image-20240212192803613.png)
...
![image-20240213114551921](/images/in-post/post_django/image-20240213114551921.png)
...
![image-20240213121211702](/images/in-post/post_django/image-20240213121211702.png)
...
![image-20240213121340027](/images/in-post/post_django/image-20240213121340027.png)



views.py的index请求处理方法，我们加一句打印。

![image-20240213121408003](/images/in-post/post_django/image-20240213121408003.png)
...
![image-20240214095458811](/images/in-post/post_django/image-20240214095458811.png)

![image-20240214095529865](/images/in-post/post_django/image-20240214095529865.png)

然后最终执行index视图函数，然后到index.html页面。

![image-20240214095615429](/images/in-post/post_django/image-20240214095615429.png)

![image-20240214095555412](/images/in-post/post_django/image-20240214095555412.png)
...
![image-20240214101929403](/images/in-post/post_django/image-20240214101929403.png)
...
![image-20240214102016747](/images/in-post/post_django/image-20240214102016747.png)

![image-20240214102024852](/images/in-post/post_django/image-20240214102024852.png)
...
![image-20240214102933139](/images/in-post/post_django/image-20240214102933139.png)
...
![image-20240214110103791](/images/in-post/post_django/image-20240214110103791.png)
...
![image-20240214111820848](/images/in-post/post_django/image-20240214111820848.png)
...
![image-20240214203510469](/images/in-post/post_django/image-20240214203510469.png)
...
![image-20240214205436954](/images/in-post/post_django/image-20240214205436954.png)
...
![image-20240214205539794](/images/in-post/post_django/image-20240214205539794.png)
...
![image-20240214210117230](/images/in-post/post_django/image-20240214210117230.png)
...
![image-20240214210210839](/images/in-post/post_django/image-20240214210210839.png)
...
![image-20240215182312654](/images/in-post/post_django/image-20240215182312654.png)
...
![image-20240215183407545](/images/in-post/post_django/image-20240215183407545.png)
...
![image-20240215192246072](/images/in-post/post_django/image-20240215192246072.png)
...
![image-20240215193854795](/images/in-post/post_django/image-20240215193854795.png)
...
![image-20240215195534704](/images/in-post/post_django/image-20240215195534704.png)
...
![image-20240215195754140](/images/in-post/post_django/image-20240215195754140.png)
...
![image-20240216110307884](/images/in-post/post_django/image-20240216110307884.png)
...
![image-20240216113028234](/images/in-post/post_django/image-20240216113028234.png)
...
![image-20240216113425405](/images/in-post/post_django/image-20240216113425405.png)
...
![image-20240216113717071](/images/in-post/post_django/image-20240216113717071.png)
...
![image-20240216122419239](/images/in-post/post_django/image-20240216122419239.png)
...
![image-20240216123224384](/images/in-post/post_django/image-20240216123224384.png)
...
为了解决上述痛点，Django 内置了强大的用户认证系统--auth，可以高效地实现登录和权限等需求。它默认使用 auth_user 表来存储用户数据。
