...
- [前言](#前言)
- [常见问题](#常见问题)
- [解决方案一：代理模式调整](#解决方案一代理模式调整)
  - [1. 登录授权卡住问题](#1-登录授权卡住问题)
  - [2. 账号设置转圈问题](#2-账号设置转圈问题)
  - [3. 账号资格问题](#3-账号资格问题)
- [解决方案二：使用 Proxifier](#解决方案二使用-proxifier)
  - [下载并激活 Proxifier](#下载并激活-proxifier)
  - [配置代理服务器](#配置代理服务器)
  - [给 Antigravity 设置规则](#给-antigravity-设置规则)
- [总结](#总结)
- [常见问题排查清单](#常见问题排查清单)
- [快速开始：3步搞定](#快速开始3步搞定)
- [TUN 模式配置指南](#tun-模式配置指南)
  - [Clash 开启 TUN 模式](#clash-开启-tun-模式)
  - [其他代理客户端](#其他代理客户端)
- [常见问题补充](#常见问题补充)
  - [模型加载失败怎么办？](#模型加载失败怎么办)
  - [为什么建议使用 Gemini Pro？](#为什么建议使用-gemini-pro)
  - [如何检查我的账号是否有 Gemini Pro？](#如何检查我的账号是否有-gemini-pro)
- [附录：推荐节点配置](#附录推荐节点配置)
- [注意事项](#注意事项)
- [参考资料](#参考资料)
...
![Antigravity IDE 界面](/images/in-post/antigravity-preview.svg)
