...
- [C#简介：能做什么，解决什么问题？](#c简介能做什么解决什么问题)
  - [C#能做什么？](#c能做什么)
  - [C#解决了什么问题？](#c解决了什么问题)
- [C#数据类型详解](#c数据类型详解)
  - [为什么需要对数据类型进行分类管理？](#为什么需要对数据类型进行分类管理)
  - [C#数据类型分类](#c数据类型分类)
  - [值类型与引用类型的区别](#值类型与引用类型的区别)
  - [结构体（struct）详解](#结构体struct详解)
  - [枚举（enum）详解](#枚举enum详解)
- [C#类型转换详解](#c类型转换详解)
  - [隐式类型转换（Implicit Conversion）](#隐式类型转换implicit-conversion)
  - [显式类型转换（Explicit Conversion）和强制类型转换（Casting）](#显式类型转换explicit-conversion和强制类型转换casting)
- [C#运算符详解](#c运算符详解)
  - [算术运算符](#算术运算符)
  - [比较运算符](#比较运算符)
  - [逻辑运算符](#逻辑运算符)
...
- [C#函数详解](#c函数详解)
  - [函数的基本结构](#函数的基本结构)
  - [函数的定义和调用](#函数的定义和调用)
  - [return语句详解](#return语句详解)
  - [函数参数详解](#函数参数详解)
  - [函数重载](#函数重载)
  - [匿名函数与Lambda表达式（基础概念）](#匿名函数与lambda表达式基础概念)
  - [Func委托（基础概念）](#func委托基础概念)
  - [Action委托（基础概念）](#action委托基础概念)
  - [Predicate委托（基础概念）](#predicate委托基础概念)
  - [Func与Action的应用场景](#func与action的应用场景)
- [C# Math类详解](#c-math类详解)
  - [Math类的基本数学运算](#math类的基本数学运算)
  - [幂运算和根运算](#幂运算和根运算)
  - [三角函数](#三角函数)
  - [实用的三角函数示例](#实用的三角函数示例)
  - [Math类的常量](#math类的常量)
  - [随机数生成](#随机数生成)
  - [舍入和精度控制](#舍入和精度控制)
  - [Math类的实际应用示例](#math类的实际应用示例)
  - [Math类使用注意事项](#math类使用注意事项)
  - [Math类常用函数速查表](#math类常用函数速查表)
- [C# Random类详解](#c-random类详解)
  - [Random类的基本使用](#random类的基本使用)
  - [Random类的构造函数](#random类的构造函数)
  - [Random类常用方法详解](#random类常用方法详解)
  - [Random类的实际应用示例](#random类的实际应用示例)
  - [Random类使用注意事项](#random类使用注意事项)
  - [Random类常用方法速查表](#random类常用方法速查表)
- [C# DateTime类详解](#c-datetime类详解)
  - [DateTime类的基本概念](#datetime类的基本概念)
  - [DateTime的创建和初始化](#datetime的创建和初始化)
  - [DateTime的常用属性](#datetime的常用属性)
  - [DateTime的格式化](#datetime的格式化)
  - [DateTime的计算和比较](#datetime的计算和比较)
  - [TimeSpan类详解](#timespan类详解)
  - [DateTime的解析](#datetime的解析)
  - [高级时间解析](#高级时间解析)
  - [时间戳处理](#时间戳处理)
  - [DateTime的实际应用示例](#datetime的实际应用示例)
  - [DateTime使用注意事项](#datetime使用注意事项)
  - [DateTime类常用属性和方法速查表](#datetime类常用属性和方法速查表)
- [C# Array类详解](#c-array类详解)
  - [Array类的基本概念](#array类的基本概念)
  - [Array的创建和初始化](#array的创建和初始化)
  - [Array的常用属性](#array的常用属性)
  - [Array的常用方法](#array的常用方法)
  - [Array的实际应用示例](#array的实际应用示例)
  - [Array使用注意事项](#array使用注意事项)
  - [Array类常用属性和方法速查表](#array类常用属性和方法速查表)
- [C# String类详解](#c-string类详解)
  - [String类的基本概念](#string类的基本概念)
  - [String的创建和初始化](#string的创建和初始化)
  - [String的常用属性](#string的常用属性)
  - [String的常用方法](#string的常用方法)
  - [StringBuilder类](#stringbuilder类)
  - [字符串比较](#字符串比较)
  - [字符串的实际应用示例](#字符串的实际应用示例)
  - [字符串与性能优化](#字符串与性能优化)
  - [String使用注意事项](#string使用注意事项)
  - [String类常用属性和方法速查表](#string类常用属性和方法速查表)
  - [StringBuilder类常用方法速查表](#stringbuilder类常用方法速查表)
- [C# Object类详解](#c-object类详解)
  - [Object类的基本概念](#object类的基本概念)
  - [Object类的常用方法](#object类的常用方法)
  - [Object的运算和比较](#object的运算和比较)
...
graph TD
    subgraph 栈内存 Stack
        V1[int x = 10]
        V2[struct Point {X=1, Y=2}]
        RefPtr[Person p -> 指向堆内存地址 0x00FF]
    end
    subgraph 堆内存 Heap
        RefPtr -->|引用地址| Obj[Person 对象实例 { Name='Toby', Age=25 }]
    end
```
