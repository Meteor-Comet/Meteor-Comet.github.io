...
- [工业自动化硬件大全](#工业自动化硬件大全)
- [一、工控机与核心控制系统](#一-工控机与核心控制系统)
  - [1.1 工控机（IPC）概述与选型](#1-1-工控机-ipc-概述与选型)
  - [1.2 工控机内部组件](#1-2-工控机内部组件)
  - [1.3 工控机周边设备](#1-3-工控机周边设备)
  - [1.4 运动控制卡 — 固高（脉冲型 vs 总线型）](#1-4-运动控制卡-固高-脉冲型-vs-总线型)
  - [1.5 PLC 扩展模块 — 汇川系列](#1-5-plc-扩展模块-汇川系列)
- [二、系统硬件拓扑与总线架构](#二-系统硬件拓扑与总线架构)
  - [2.1 EtherCAT 总线架构](#2-1-ethercat-总线架构)
  - [2.2 传统脉冲式接线（固高）](#2-2-传统脉冲式接线-固高)
  - [2.3 EtherCAT 与脉冲式接线对比](#2-3-ethercat-与脉冲式接线对比)
  - [2.4 完整网络拓扑（PLC/交换机/机顶/MES）](#2-4-完整网络拓扑-plc-交换机-机顶-mes)
  - [2.5 SMEMA 信号转接隔离模块](#2-5-smema-信号转接隔离模块)
- [三、电机类型与驱动器](#三-电机类型与驱动器)
  - [3.1 基础知识：开闭环控制、编码器、PID 与惯量比](#3-1-基础知识-开闭环控制-编码器-pid-与惯量比)
  - [3.2 伺服电机与驱动器（汇川）](#3-2-伺服电机与驱动器-汇川)
  - [3.3 步进电机](#3-3-步进电机)
  - [3.4 直线电机](#3-4-直线电机)
  - [3.5 直驱电机（DD 马达）](#3-5-直驱电机-dd-马达)
  - [3.6 力矩电机](#3-6-力矩电机)
  - [3.7 无刷直流减速电机](#3-7-无刷直流减速电机)
  - [3.8 各类型对比与选型建议](#3-8-各类型对比与选型建议)
  - [3.9 驱动器与驱动方式（补充）](#3-9-驱动器与驱动方式-补充)
- [四、轴参数配置详解](#四-轴参数配置详解)
  - [4.1 每圈脉冲（PlusPerR）](#4-1-每圈脉冲-plusperr)
  - [4.2 减速比（GeerRate）](#4-2-减速比-geerrate)
  - [4.3 导程（LeadLength）](#4-3-导程-leadlength)
  - [4.4 工作速度（WorkSpeed）](#4-4-工作速度-workspeed)
  - [4.5 核心换算公式（脉冲当量）](#4-5-核心换算公式-脉冲当量)
  - [4.6 完整换算链](#4-6-完整换算链)
- [五、IO 系统与数字量分类](#五-io-系统与数字量分类)
  - [5.1 设备数字量 IO 分类概述](#5-1-设备数字量-io-分类概述)
  - [5.2 远程 IO 模块（EtherCAT 总线）](#5-2-远程-io-模块-ethercat-总线)
  - [5.3 本地 IO 扩展模块 — 固高 HCB5-1616-DTD01](#5-3-本地-io-扩展模块-固高-hcb5-1616-dtd01)
  - [5.4 阀岛（EtherCAT 总线阀岛）](#5-4-阀岛-ethercat-总线阀岛)
  - [5.5 接线规则（OUT 连 IN 串联）](#5-5-接线规则-out-连-in-串联)
- [六、传感器与识别系统](#六-传感器与识别系统)
  - [6.1 数字量输入（DI）类型概览](#6-1-数字量输入-di-类型概览)
  - [6.2 数字量输出（DO）类型概览](#6-2-数字量输出-do-类型概览)
  - [6.3 槽型光电传感器 — 松下 PM-Y45 / PM-T45](#6-3-槽型光电传感器-松下-pm-y45-pm-t45)
  - [6.4 反射型与对射型光电传感器](#6-4-反射型与对射型光电传感器)
  - [6.5 气缸磁性传感器 — SMC D-M9B](#6-5-气缸磁性传感器-smc-d-m9b)
  - [6.6 接近传感器](#6-6-接近传感器)
  - [6.7 光纤传感器](#6-7-光纤传感器)
  - [6.8 压力传感器](#6-8-压力传感器)
  - [6.9 温度传感器](#6-9-温度传感器)
  - [6.10 编码器](#6-10-编码器)
  - [6.11 工业扫码枪 — 康耐视 DM262_16MM-COV](#6-11-工业扫码枪-康耐视-dm26216mm-cov)
- [七、工业视觉系统](#七-工业视觉系统)
  - [7.1 上/下 CCD 视觉系统 — 凌云光相机 & RBM 光源](#7-1-上-下-ccd-视觉系统-凌云光相机-rbm-光源)
- [八、气动执行机构](#八-气动执行机构)
  - [8.1 真空一体阀与电磁阀岛](#8-1-真空一体阀与电磁阀岛)
  - [8.2 电磁阀岛](#8-2-电磁阀岛)
  - [8.3 气缸](#8-3-气缸)
- [九、机架与配盘相关](#九-机架与配盘相关)
  - [9.1 三脚插头 / 航空插头](#9-1-三脚插头-航空插头)
  - [9.2 电门开关 / 急停按钮 / 按钮开关](#9-2-电门开关-急停按钮-按钮开关)
  - [9.3 三色灯 / 日光灯 / 指示灯](#9-3-三色灯-日光灯-指示灯)
  - [9.4 安全门锁 / 安全光幕](#9-4-安全门锁-安全光幕)
  - [9.5 接地铜条](#9-5-接地铜条)
  - [9.6 FFU（风机过滤单元）/ 风扇](#9-6-ffu-风机过滤单元-风扇)
  - [9.7 十孔排插](#9-7-十孔排插)
  - [9.8 传感器安装与配盘注意事项](#9-8-传感器安装与配盘注意事项)
- [十、配盘（电控柜）相关](#十-配盘-电控柜-相关)
  - [10.1 维修插座](#10-1-维修插座)
  - [10.2 漏电断路器 / 断路器（空气开关）](#10-2-漏电断路器-断路器-空气开关)
  - [10.3 时间继电器 / 安全继电器 / 电磁继电器](#10-3-时间继电器-安全继电器-电磁继电器)
  - [10.4 滤波保险端子台 / 电源滤波器](#10-4-滤波保险端子台-电源滤波器)
  - [10.5 交流接触器](#10-5-交流接触器)
  - [10.6 开关电源](#10-6-开关电源)
  - [10.7 熔断器](#10-7-熔断器)
  - [10.8 典型应用：配电元件选型案例](#10-8-典型应用-配电元件选型案例)
- [十一、专用执行设备](#十一-专用执行设备)
  - [11.1 点胶阀](#11-1-点胶阀)
  - [11.2 UV 控制器](#11-2-uv-控制器)
  - [11.3 振动盘](#11-3-振动盘)
  - [11.4 螺丝机](#11-4-螺丝机)
  - [11.5 飞达（Feeder）](#11-5-飞达-feeder)
- [十二、现场连接与走线规范](#十二-现场连接与走线规范)
  - [12.1 8位集线分线接线盒 — H450 系列](#12-1-8位集线分线接线盒-h450-系列)
  - [12.2 拖链与高柔性线缆](#12-2-拖链与高柔性线缆)
  - [12.3 M12 连接器与端子排](#12-3-m12-连接器与端子排)
  - [12.4 接线端子与型号速查](#12-4-接线端子与型号速查)
  - [12.5 接地系统](#12-5-接地系统)
  - [12.6 附录：接线BOM详解（线材/电源/继电器/IO补充）](#12-6-附录-接线bom详解-线材-电源-继电器-io补充)
  - [12.7 线材分类选型与 BOM 对应关系（7 类法）](#12-7-线材分类选型与-bom-对应关系-7-类法)
- [十三、附录：整机电气 BOM 速查表](#十三-附录-整机电气-bom-速查表)
