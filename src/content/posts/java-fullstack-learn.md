...
## 目录
  ...
  - [学习目标](#学习目标)
  - [学习计划](#学习计划)
- [1.Java基础：JDK、JRE、JVM的关系与作用](#1java基础jdkjrejvm的关系与作用)
- [2.Java主要关键词及其作用](#2java主要关键词及其作用)
- [3. Java中的字面量分类](#3-java中的字面量分类)
- [4. Java变量定义的格式](#4-java变量定义的格式)
  - [示例](#示例)
- [5. Java中的键盘录入](#5-java中的键盘录入)
  - [基本用法](#基本用法)
  - [示例代码](#示例代码)
- [6. IDEA中Java项目的结构介绍](#6-idea中java项目的结构介绍)
  - [主要部分说明](#主要部分说明)
  - [项目、模块、类的概念与关系](#项目模块类的概念与关系)
- [7. Java运算符及其运算规则](#7-java运算符及其运算规则)
  - [1. 算术运算符](#1-算术运算符)
  - [2. 赋值运算符](#2-赋值运算符)
  - [3. 比较（关系）运算符](#3-比较关系运算符)
  - [4. 逻辑运算符](#4-逻辑运算符)
  - [5. 位运算符](#5-位运算符)
  - [6. 条件（三元）运算符](#6-条件三元运算符)
  - [7. 字符串连接运算符](#7-字符串连接运算符)
  - [8. instanceof 运算符](#8-instanceof-运算符)
- [8. Java字符串运算规则](#8-java字符串运算规则)
- [9. 原码、反码与补码](#9-原码反码与补码)
  - [1. 原码](#1-原码)
  - [2. 反码](#2-反码)
  - [3. 补码](#3-补码)
  - [4. 转换规则总结](#4-转换规则总结)
  - [5. Java中的意义](#5-java中的意义)
  - [6. 示例](#6-示例)
- [10. Java三大程序结构](#10-java三大程序结构)
  - [10.1 顺序结构](#101-顺序结构)
  - [10.2 分支结构（选择结构）](#102-分支结构选择结构)
  - [10.3 循环结构](#103-循环结构)
- [11. Java中的Random库](#11-java中的random库)
  - [基本用法](#基本用法)
  - [常用方法](#常用方法)
  - [示例代码](#示例代码)
- [12. Java中的next命名规范详细解释](#12-java中的next命名规范详细解释)
  - [1. 设计思想](#1-设计思想)
  - [2. 常见场景](#2-常见场景)
  - [3. 与hasNext的配合](#3-与hasnext的配合)
  - [4. 易混淆点](#4-易混淆点)
  - [5. 实际开发建议](#5-实际开发建议)
- [13. Java数组基础](#13-java数组基础)
  - [13.1 数组的概念](#131-数组的概念)
  - [13.2 数组的声明与初始化](#132-数组的声明与初始化)
  - [13.3 访问和修改数组元素](#133-访问和修改数组元素)
  - [13.4 数组的遍历](#134-数组的遍历)
  - [13.5 数组的常用属性和特性](#135-数组的常用属性和特性)
  - [13.6 示例：求数组元素之和](#136-示例求数组元素之和)
  - [13.7 直接输出数组与地址格式说明](#137-直接输出数组与地址格式说明)
  - [13.8 动态初始化时的默认值](#138-动态初始化时的默认值)
- [14. Java内存分布](#14-java内存分布)
  - [1. 方法区（Method Area）](#1-方法区method-area)
  - [2. 堆（Heap）](#2-堆heap)
  - [3. 虚拟机栈（Stack）](#3-虚拟机栈stack)
  - [4. 本地方法栈（Native Method Stack）](#4-本地方法栈native-method-stack)
  - [5. 程序计数器（Program Counter Register）](#5-程序计数器program-counter-register)
  - [6. 内存分布结构图](#6-内存分布结构图)
  - [7. 总结](#7-总结)
- [15. Java方法基础](#15-java方法基础)
  - [1. 方法的概念](#1-方法的概念)
  - [2. 方法的定义格式](#2-方法的定义格式)
  - [3. 方法的调用](#3-方法的调用)
  - [4. 方法的重载（Overload）](#4-方法的重载overload)
  - [5. 常见修饰符说明](#5-常见修饰符说明)
  - [6. void方法和return](#6-void方法和return)
  - [7. 参数传递](#7-参数传递)
  - [8. 方法参数传递机制详解](#8-方法参数传递机制详解)
- [16. Java二维数组的创建与初始化](#16-java二维数组的创建与初始化)
  - [1. 二维数组的声明](#1-二维数组的声明)
  - [2. 二维数组的创建](#2-二维数组的创建)
  - [3. 二维数组的静态初始化](#3-二维数组的静态初始化)
  - [4. 访问和遍历二维数组](#4-访问和遍历二维数组)
  - [5. 特点说明](#5-特点说明)
- [17. Java面向对象编程（OOP）基础](#17-java面向对象编程oop基础)
  - [1. 类与对象](#1-类与对象)
  - [2. 封装（Encapsulation）](#2-封装encapsulation)
  - [3. 继承（Inheritance）](#3-继承inheritance)
  - [4. 多态（Polymorphism）](#4-多态polymorphism)
  - [5. 构造方法（Constructor）](#5-构造方法constructor)
  - [6. this与super关键字](#6-this与super关键字)
  - [7. 方法重写（Override）与重载（Overload）](#7-方法重写override与重载overload)
  - [8. final与abstract](#8-final与abstract)
  - [9. 接口（Interface）](#9-接口interface)
  - [10. 静态成员（static）](#10-静态成员static)
  - [11. 内部类](#11-内部类)
  - [12. 对象的创建与内存分布](#12-对象的创建与内存分布)
  - [13. 常见OOP原则](#13-常见oop原则)
  - [面向对象的内存分布说明](#面向对象的内存分布说明)
  - [Java对象与引用的内存分布详解](#java对象与引用的内存分布详解)
- [18.Java的基本数据类型与引用数据类型](#18java的基本数据类型与引用数据类型)
  - [1. 基本数据类型（Primitive Types）](#1-基本数据类型primitive-types)
  - [2. 引用数据类型（Reference Types）](#2-引用数据类型reference-types)
  - [3. 区别总结](#3-区别总结)
- [19.this关键字的内存原理](#19this关键字的内存原理)
  - [1. this的本质](#1-this的本质)
  - [2. 内存表现](#2-内存表现)
  - [3. 作用和常见用法](#3-作用和常见用法)
  - [4. 注意事项](#4-注意事项)
- [20.Java对象数组](#20java对象数组)
  - [1. 概念](#1-概念)
  - [2. 声明与创建](#2-声明与创建)
  - [3. 遍历对象数组](#3-遍历对象数组)
  - [4. 内存分布说明](#4-内存分布说明)
  - [5. 注意事项](#5-注意事项)
- [21.Java字符串（String）常用API](#21java字符串string常用api)
  - [1. 字符串的创建](#1-字符串的创建)
  - [2. 字符串的不可变性](#2-字符串的不可变性)
  - [3. 常用API方法](#3-常用api方法)
  - [4. 示例代码](#4-示例代码)
  - [5. 字符串拼接与效率](#5-字符串拼接与效率)
  - [6. String构造方法参数说明](#6-string构造方法参数说明)
- [22.StringBuilder与StringBuffer](#22stringbuilder与stringbuffer)
  - [1. 概念与区别](#1-概念与区别)
  - [2. 常用API](#2-常用api)
  - [3. 示例代码](#3-示例代码)
  - [4. 适用场景](#4-适用场景)
  - [StringBuilder和StringBuffer的区别](#stringbuilder和stringbuffer的区别)
- [23.Java链式编程（链式调用）](#23java链式编程链式调用)
  - [1. 概念](#1-概念)
  - [2. 实现原理](#2-实现原理)
  - [3. 常见场景](#3-常见场景)
  - [4. 优缺点](#4-优缺点)
- [24.StringJoiner的用法](#24stringjoiner的用法)
  - [1. 概念](#1-概念)
  - [2. 构造方法](#2-构造方法)
  - [3. 常用API](#3-常用api)
  - [4. 示例代码](#4-示例代码)
  - [5. 适用场景](#5-适用场景)
- [25.Java字符串（String）的底层原理](#25java字符串string的底层原理)
  - [1. 不可变性](#1-不可变性)
  - [2. 内存结构](#2-内存结构)
  - [3. 字符串常量池](#3-字符串常量池)
  - [4. 字符串比较](#4-字符串比较)
  - [5. 字符串拼接机制](#5-字符串拼接机制)
  - [6. 性能影响](#6-性能影响)
  - [7. 字符串拼接的底层原理](#7-字符串拼接的底层原理)
  - [8. 直接赋值字符串与变量拼接字符串的==比较](#8-直接赋值字符串与变量拼接字符串的比较)
- [26.Java集合框架基础](#26java集合框架基础)
  - [1. 集合的概念](#1-集合的概念)
  - [2. 主要接口与体系结构](#2-主要接口与体系结构)
  - [3. 常用实现类](#3-常用实现类)
  - [4. 基本用法与常见操作](#4-基本用法与常见操作)
  - [5. 示例代码](#5-示例代码)
  - [6. 遍历集合](#6-遍历集合)
- [27. Java泛型（Generics）](#27-java泛型generics)
  - [1. 概念](#1-概念)
  - [2. 基本语法](#2-基本语法)
  - [3. 集合中的泛型](#3-集合中的泛型)
  - [4. 通配符与类型限定](#4-通配符与类型限定)
  - [5. 好处](#5-好处)
- [28. 数组与集合的选择：什么时候用集合，什么时候用数组？](#28-数组与集合的选择什么时候用集合什么时候用数组)
  - [一、数组适用场景](#一数组适用场景)
  - [二、集合适用场景](#二集合适用场景)
  - [三、选择建议](#三选择建议)
  - [四、举例说明](#四举例说明)
  - [五、总结口诀](#五总结口诀)
- [29. static关键字详解](#29-static关键字详解)
  - [一、static的作用](#一static的作用)
  - [二、static的常见用法](#二static的常见用法)
  - [三、static的适用场景](#三static的适用场景)
  - [四、注意事项](#四注意事项)
  - [五、常见面试点](#五常见面试点)
  - [六、示例代码](#六示例代码)
- [30. Java中的继承（Inheritance）](#30-java中的继承inheritance)
  - [1. 概念](#1-概念)
  - [2. 语法](#2-语法)
  - [3. 特性](#3-特性)
  ...
  - [7. final/abstract与继承](#7-finalabstract与继承)
  - [8. 单继承与多态](#8-单继承与多态)
  - [9. 常见面试点](#9-常见面试点)
  - [10. 示例代码](#10-示例代码)
  - [11. 继承中成员变量和成员方法的访问与重写](#11-继承中成员变量和成员方法的访问与重写)
- [30.2 Java方法重写（Override）详解](#302-java方法重写override详解)
  - [1. 概念](#1-概念)
  - [2. 语法规则](#2-语法规则)
  - [3. @Override注解](#3-override注解)
  - [4. 与重载（Overload）的区别](#4-与重载overload的区别)
  - [5. 常见面试点](#5-常见面试点)
  - [6. 示例代码](#6-示例代码)
  - [12. 继承中构造方法的自动调用（super）](#12-继承中构造方法的自动调用super)
  - [13. 构造方法中this(...)的含义与用法](#13-构造方法中this的含义与用法)
  - [14. 多态（Polymorphism）](#14-多态polymorphism)
  - [15. 多态中成员变量与成员方法的调用机制](#15-多态中成员变量与成员方法的调用机制)
  - [16. 多态中的强制类型转换](#16-多态中的强制类型转换)
  - [17. Java包（package）的命名规范、作用与分类](#17-java包package的命名规范作用与分类)
