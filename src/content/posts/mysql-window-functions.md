...
- [学习目标](#学习目标)
- [学习计划](#学习计划)
- [1. 窗口函数基础与语法](#1-窗口函数基础与语法)
- [2. 排名类函数](#2-排名类函数)
  - [2.1 ROW_NUMBER](#21-row_number)
  - [2.2 RANK](#22-rank)
  - [2.3 DENSE_RANK](#23-dense_rank)
  - [2.4 NTILE(n)](#24-ntilen)
- [3. 偏移类函数](#3-偏移类函数)
  - [3.1 LAG/LEAD](#31-laglead)
  - [3.2 FIRST_VALUE / LAST_VALUE](#32-first_value--last_value)
  - [3.3 NTH_VALUE](#33-nth_value)
- [4. 聚合窗口](#4-聚合窗口)
  - [4.1 累计值（running total）](#41-累计值running-total)
  - [4.2 滑动窗口（近N行）](#42-滑动窗口近n行)
  - [4.3 同比/环比（与上一期比较）](#43-同比环比与上一期比较)
- [5. 窗口帧（FRAME）与ROWS/RANGE](#5-窗口帧frame与rowsrange)
- [6. 实战示例：电商销售](#6-实战示例电商销售)
  - [6.1 示例表结构](#61-示例表结构)
  - [6.2 需求1：用户内订单金额排名并取Top3](#62-需求1用户内订单金额排名并取top3)
  - [6.3 需求2：计算用户累计消费与上/下单金额](#63-需求2计算用户累计消费与上下单金额)
  - [6.4 需求3：按月环比增长率](#64-需求3按月环比增长率)
- [7. 注意事项与性能优化](#7-注意事项与性能优化)
- [8. 练习题与扩展](#8-练习题与扩展)
- [总结](#总结)
