...
- [新设备设置](#新设备设置)
- [Win10更改AppData默认存储路径方法](#win10更改appdata默认存储路径方法)
  - [一、修改Windows用户账户文件夹路径](#一修改windows用户账户文件夹路径)
...
2. 定位到：
   ...
   ![ProfileList注册表截图](/images/in-post/post-big-data-20250108/profilelist-admin.png)
