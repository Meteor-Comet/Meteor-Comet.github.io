...
image: /images/numpy-pandas-matplotlib-learn.jpg
category: Python
tags:
  - 数据分析
  - Python
...
- [学习计划](#学习计划)
- [1. NumPy基础](#1-numpy基础)
  - [1.1 NumPy概述](#11-numpy概述)
  - [1.2 创建数组](#12-创建数组)
  - [1.3 数组操作](#13-数组操作)
  - [1.4 数学运算](#14-数学运算)
  - [1.5 广播机制](#15-广播机制)
- [2. Pandas核心](#2-pandas核心)
  - [2.1 Pandas概述](#21-pandas概述)
  - [2.2 Series操作](#22-series操作)
  - [2.3 DataFrame操作](#23-dataframe操作)
  - [2.4 数据选择和索引](#24-数据选择和索引)
  - [2.5 数据处理](#25-数据处理)
  - [2.6 数据合并和连接](#26-数据合并和连接)
- [3. Matplotlib可视化](#3-matplotlib可视化)
  - [3.1 Matplotlib概述](#31-matplotlib概述)
  - [3.2 基础绘图](#32-基础绘图)
  - [3.3 多子图](#33-多子图)
  - [3.4 统计图表](#34-统计图表)
  - [3.5 高级可视化](#35-高级可视化)
- [4. 三库协同工作](#4-三库协同工作)
  - [4.1 数据科学工作流](#41-数据科学工作流)
  - [4.2 时间序列分析](#42-时间序列分析)
- [5. 实战案例](#5-实战案例)
  - [5.1 股票数据分析](#51-股票数据分析)
  - [5.2 机器学习数据预处理](#52-机器学习数据预处理)
- [6. 性能优化和最佳实践](#6-性能优化和最佳实践)
  - [6.1 NumPy优化](#61-numpy优化)
  - [6.2 Pandas优化](#62-pandas优化)
  - [6.3 可视化最佳实践](#63-可视化最佳实践)
- [总结](#总结)
  - [核心要点](#核心要点)
  - [学习建议](#学习建议)
  - [应用领域](#应用领域)
- [参考资料](#参考资料)
- [附录A：常用方法参数详解](#附录a常用方法参数详解)
  - [NumPy](#numpy)
  - [Pandas](#pandas)
  - [Matplotlib（pyplot）](#matplotlibpyplot)
- [附录B：关键代码输出示例](#附录b关键代码输出示例)
  - [NumPy 输出](#numpy-输出)
  - [Pandas 输出](#pandas-输出)
